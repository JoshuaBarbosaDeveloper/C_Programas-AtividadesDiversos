...
int main(){int inteiro, numUsu1, numUsu2;
		   ...
		   printf("\n Os valores pares entre esses numeros sao: ");

		   for (inteiro=numUsu1; inteiro<=numUsu2; inteiro++) if (inteiro%2==0) {printf("%d, ", inteiro);}}
